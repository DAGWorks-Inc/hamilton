...
Note: if you run into the "Invalid HTTP_HOST" error, then please set the environment variable `HAMILTON_ALLOWED_HOSTS` to `*` (or domain of choice) for the backend docker container. You can inject
