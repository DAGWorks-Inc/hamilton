...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(choices=[("git", "Git"), ("ad_hoc", "Ad hoc")]),
                ),
                ("code_version_info", models.JSONField(null=True)),
                ("code_version_info_schema", models.IntegerField(null=True)),
                (
                    "code_log_store",
                    models.CharField(choices=[("s3", "S3"), ("local", "Local"), ("none", "None")]),
                ),
                ("code_log_url", models.CharField(default=None, null=True)),
        ...
        migrations.AlterUniqueTogether(
            name="dagtemplate",
            unique_together={("dag_hash", "code_hash", "name")},
        ),
    ]
