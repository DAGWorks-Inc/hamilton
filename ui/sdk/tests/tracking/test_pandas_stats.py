...
def test_compute_stats_df():
    ...
    expected = {'observability_schema_version': '0.0.3',
 'observability_type': 'dagworks_describe',
 'observability_value': {'a': {'base_data_type': 'numeric',
                               'count': 5,
                               'data_type': 'int64',
                               'histogram': {'(0.995, 1.4]': 1,
                                             '(1.4, 1.8]': 0,
                                             '(1.8, 2.2]': 1,
                                             '(2.2, 2.6]': 0,
                                             '(2.6, 3.0]': 1,
                               ...
                               'zeros': 0},
                         'b': {'base_data_type': 'unhandled',
                               'count': 5,
                               'data_type': 'object',
                               'missing': 0,
                               'name': 'b',
                               'pos': 1},
                         'c': {'base_data_type': 'boolean',
                               'count': 5,
                               'data_type': 'bool',
                               'missing': 0,
                               'name': 'c',
                         ...
                         'f': {'avg_str_len': 1.0,
                               ...
                               'pos': 5,
                               'std_str_len': 0.0},
                         'g': {'base_data_type': 'unhandled',
                               'count': 5,
                               'data_type': 'object',
                               'missing': 0,
                               'name': 'g',
                               'pos': 6},
                         'h': {'base_data_type': 'datetime',
                               'count': 5,
                               'data_type': 'datetime64[ns]',
                               'histogram': {'(2022-12-30 23:59:58.999999999, 2022-12-30 23:59:59.200000]': 0,
                               ...
                               'name': 'h',
                               'pos': 7,
                               'quantiles': {0.1: '2022-12-31T00:00:00',
                         ...
                         'i': {'base_data_type': 'numeric',
                               ...
                               'std': None,
                               'zeros': 0},
                         'j': {'base_data_type': 'datetime',
                               'count': 5,
                               'data_type': 'datetime64[ns]',
                               'histogram': {'(2022-12-31 23:54:14.399999999, 2023-01-01 09:36:00]': 1,
                               ...
                               'name': 'j',
                               'pos': 9,
                               'quantiles': {0.1: '2023-01-01T09:36:00',
