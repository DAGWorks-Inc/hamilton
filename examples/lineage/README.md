...
If you want to see code and what it does we invite you to jump straight into browsing the [lineage_snippets](../../examples/lineage/lineage_snippets.ipynb) notebook.
For those coming from the lineage blog post, you can find the code shown in [lineage_script.py](../../examples/lineage/lineage_script.py).
...
lineage, and then explain how Hamilton helps you solve common problems that lineage helps solve.
...
2. Browse either the [lineage_snippets](../../examples/lineage/lineage_snippets.ipynb) notebook or the [lineage_script](../../examples/lineage/lineage_script.py)
...
to quickly get lineage answers. The script is [lineage_commands.py](../../examples/lineage/lineage_commands.py).
