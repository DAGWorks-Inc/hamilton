...
def custom_subclass_check(requested_type: Type, param_type: Type):
    ...
    #  low-level
    if has_generic and requested_origin_type in (Sequential, Parallel):
...
# Types for these annotations are basically just generators
class Sequential(Generator[T, None, None], ABC):
    pass


class Parallel(Generator[U, None, None], ABC):
    pass
