...
class PolarsReaderWriter:
    ...
    def save_data(
        self, data: Union[pl.DataFrame, pl.LazyFrame], fmt: str, file: str, kwargs: Dict
    ) -> Dict[str, Any]:
        self.file = file
        if fmt == "csv":
    ...
    def load_data(
        self, fmt: str, file: str, output: str, kwargs: Dict
    ...
    def __save_csv_data(
        self, data: Union[pl.DataFrame, pl.LazyFrame], kwargs: Dict
    ) -> Dict[str, Any]:
