...
class AsyncDriver(driver.Driver):
    ...
    def __init__(
        ...
        *modules,
        ...
        Note that this is not the desired API -- you should be using the :py:class:`hamilton.experimental.h_async.Builder` class to create the driver.
...
class Builder(driver.Builder):
    ...
    async def build(self):
        ...
        result_builder = self.result_builder if self.result_builder is not None else base.DictResult()
